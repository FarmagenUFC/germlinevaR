...
Ensembl VEP, SnpEff, or both — from on-disk VCF to filtered gvr table, candidate
...
germlinevaR is submitted to Bioconductor. Once accepted, install the release
version with:
...
into an MAF-like `data.table` (one row per ALT allele, one
...
- **Full vignette (HTML):** [germlinevaR walkthrough](https://farmagenufc.github.io/germlinevaR/articles/germlinevaR.html)
...
MIT (c) 2026 Thiago Loreto Matos, Felipe Pantoja Mesquita. See `LICENSE`.
