...
[![CRAN status](https://www.r-pkg.org/badges/version/germlinevaR)](https://CRAN.R-project.org/package=germlinevaR)
<!-- badges: end -->
...
novel variants, cohort summary, oncoplot, and per-gene protein-domain
...
- a ComplexHeatmap-based oncoplot (`gvr_plot`) and per-section standalone
