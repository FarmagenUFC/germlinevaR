...
## Session info
    ...
    #>  [4] compiler_4.6.1      BiocManager_1.30.27 zip_3.0.0          
    #>  [7] Rcpp_1.1.1-1.1      tidyselect_1.2.1    jquerylib_0.1.4    
    #> [10] systemfonts_1.3.2   scales_1.4.0        textshaping_1.0.5  
    #> [13] yaml_2.3.12         fastmap_1.2.0       ggplot2_4.0.3      
    #> [16] R6_2.6.1            generics_0.1.4      openxlsx_4.2.8.1   
    #> [19] knitr_1.51          htmlwidgets_1.6.4   tibble_3.3.1       
    #> [22] bookdown_0.47       desc_1.4.3          pillar_1.11.1      
    #> [25] bslib_0.11.0        RColorBrewer_1.1-3  rlang_1.2.0        
    #> [28] stringi_1.8.7       cachem_1.1.0        xfun_0.59          
    #> [31] fs_2.1.0            sass_0.4.10         S7_0.2.2           
    #> [34] otel_0.2.0          cli_3.6.6           pkgdown_2.2.0      
